...
public class DocumentGatewayTest {
    ...
    private Long ct; // found @ https://www.twikey.com/r/admin#/c/template
    ...
    public void createCustomer() {
        ct = Long.valueOf(System.getenv("CT"));
    ...
    public void testSignMandate() throws Exception, TwikeyClient.UserException {
        Assume.assumeTrue("APIKey and CT are set", apiKey != null && ct != null);
        SignRequest invite = new SignRequest(ct, SignRequest.SignMethod.IMPORT, customer, account)
                .setForceCheck(true)
                .setReminderDays(5);
    ...
    public void testRetrievePdf() throws IOException, TwikeyClient.UserException, InterruptedException {
        ...
        retrievedPdf.save("/Users/nathanserry/Downloads/pdf.pdf");
    ...
    public void testUploadPdf() throws Exception, TwikeyClient.UserException {
        ...
        SignRequest invite = new SignRequest(ct, SignRequest.SignMethod.PAPER, customer, account)
                .setForceCheck(true)
                .setReminderDays(5);
        DocumentResponse.MandateCreationResponse response = api.document().sign(invite);
        assertNotNull("Document Reference", response.getMandateNumber());
        UploadPdfRequest pdfRequest = new UploadPdfRequest(response.getMandateNumber(), "/Users/nathanserry/Downloads/pdf.pdf");
