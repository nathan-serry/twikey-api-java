...
//            }
    ...
    class BulkInvoiceRequest {
        ...
        private final List<CreateInvoiceRequest> invoices;
         ...
         */
        public BulkInvoiceRequest(List<CreateInvoiceRequest> invoices) {
        ...
        public List<CreateInvoiceRequest> getInvoices() {
            return invoices;
        }
    }
